export default class Hero {
    constructor(heroMesh, id, speed, scaling, scene) {
        ...
        // scaling
        this.heroMesh.scaling = new BABYLON.Vector3(0.2, 0.2, 0.2);
        ...
        if (Hero.boundingBoxParameters == undefined) {
            Hero.boundingBoxParameters = this.calculateBoundingBoxParameters();
        }

        this.bounder = this.createBoundingBox();
        this.bounder.heroMesh = this.heroMesh;
    }
    ...
    move(scene) {
        ...
        this.heroMesh.position = new BABYLON.Vector3(this.bounder.position.x,
            this.bounder.position.y, this.bounder.position.z);

        // follow the tank
        let tank = scene.getMeshByName("heroTank");
        // let's compute the direction vector that goes from Dude to the tank
        let direction = tank.position.subtract(this.heroMesh.position);
        ...
        this.heroMesh.rotation.y = alpha;
    ...
    calculateBoundingBoxParameters() {
        ...
        let childrenMeshes = this.heroMesh.getChildren();
    ...
    createBoundingBox() {
        ...
        bounder.position = this.heroMesh.position.clone();

        let bbInfo = Hero.boundingBoxParameters;
